...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div class="col-lg-8">
        <form method="post" action="/dashboard/sewa/{{ $sewa->id }}" enctype="multipart/form-data">
            @method('put')
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="hidden" name="oldImage" value="{{ $sewa->image }}">
                @if($sewa->image)
                    <img src="{{ asset('storage/' . $sewa->image) }}" class="img-preview img-fluid mb-3 col-sm-5 d-block">
                @else
